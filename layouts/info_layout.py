...
def info_layout(mode, sfp_data, unit_id, remote_unit_id, local_unit_ip, remote_unit_ip, local_sw_version, remote_sw_version):
    if mode == "primary":
        ...
        info_panel_local = unit_info_panel("local", local_unit_ip, unit_id, local_sw_version, sfp_data.get("local", {}))
        info_panel_remote = unit_info_panel("remote", remote_unit_ip, remote_unit_id, remote_sw_version, sfp_data.get("remote", {}))
    ...
    if mode == "secondary":
        ...
        info_panel_local = unit_info_panel("local", local_unit_ip, unit_id, local_sw_version, sfp_data.get("local", {}))  # koruza is in secodary mode but data is from "primary" as it's local
