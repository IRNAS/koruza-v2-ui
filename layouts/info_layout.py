...
def info_layout(mode, sfp_data, unit_id, remote_unit_id, local_unit_ip, remote_unit_ip, local_unit_mode, remote_unit_mode, local_sw_version, remote_sw_version, local_motor_status, remote_motor_status):
    if mode == "primary":
        ...
        info_panel_local = unit_info_panel("local", local_unit_ip, unit_id, local_unit_mode, local_sw_version, sfp_data.get("local", {}), local_motor_status)
        info_panel_remote = unit_info_panel("remote", remote_unit_ip, remote_unit_id, remote_unit_mode, remote_sw_version, sfp_data.get("remote", {}), remote_motor_status)
    ...
    if mode == "secondary":
        ...
        info_panel_local = unit_info_panel("local", local_unit_ip, unit_id, local_unit_mode, local_sw_version, sfp_data.get("local", {}), local_motor_status)  # koruza is in secodary mode but data is from "primary" as it's local
